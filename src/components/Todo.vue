<template>
  ...
  <div class="card" v-if="task.CategoryId === 2">
    ...
    <div class="card-body">
      ...
      <div class="footer">
        <button type="button" class="btn btn-success forward" data-bs-dismiss="modal" @click.prevent="backlog(task.id)"><i class="bi bi-chevron-left"></i>Backlog</button>
        <button type="button" class="btn btn-success forward" data-bs-dismiss="modal" @click.prevent="doing(task.id)">Doing<i class="bi bi-chevron-right"></i></button>
      </div>
    </div>
